...
export class GraphicView extends ComplexView implements MoveDrawable {
  ...
  protected _type: ElementType = ElementType.GRAPHIC;
...
// export class GraphicView extends ComplexView implements MoveDrawable {
//   protected override svgElement: SVGElement = document.createElementNS(ElementView.svgURI, "svg");
