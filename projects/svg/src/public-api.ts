...
export * from './element/shape/path/PathView';
...
export * from './element/shape/path/FreeView';
...
export * from './service/tool/draw/mode/ClickDrawer';
export * from './service/tool/draw/mode/FreeDrawer';
export * from './service/tool/draw/mode/MoveDrawer';
...
export * from './service/tool/edit/table/EditTableTool';
